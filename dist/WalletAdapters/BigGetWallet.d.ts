...
interface BitgetProvider extends Omit<BaseWalletAdapter, 'signAndSubmitTransaction' | 'connect' | 'network' | 'onNetworkChange' | 'onAccountChange'> {
...
export declare const BitgetWalletName: WalletName<"Bitget Wallet">;
...
export declare class BitgetWalletAdapter extends BaseWalletAdapter {
...
export {};
//# sourceMappingURL=BigGetWallet.d.ts.map