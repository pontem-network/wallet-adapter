...
exports.BitgetWalletAdapter = exports.BitgetWalletName = void 0;
const BaseAdapter_1 = require("./BaseAdapter");
const WalletProviders_1 = require("../WalletProviders");
exports.BitgetWalletName = 'Bitget Wallet';
class BitgetWalletAdapter extends BaseAdapter_1.BaseWalletAdapter {
    ...
    connect() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!response) {
                    throw new WalletProviders_1.WalletNotConnectedError(`${exports.BitgetWalletName} Connect Error`);
                }
    ...
    getNetwork() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!response)
                    throw `${exports.BitgetWalletName} Network Error`;
                return {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (typeof message !== 'object' || !message.nonce) {
                    `${exports.BitgetWalletName} Invalid signMessage Payload`;
                }
                ...
                if (response) {
                    ...
                    throw `${exports.BitgetWalletName} Sign Message failed`;
                }
            }
            catch (error) {
                const errMsg = error.message;
...
//# sourceMappingURL=BigGetWallet.js.map