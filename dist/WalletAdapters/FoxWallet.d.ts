...
export declare const FoxWalletName: WalletName<"FoxWallet">;
export interface FoxWalletAdapterConfig {
    provider?: IFoxWallet;
    timeout?: number;
}
export declare class FoxWalletAdapter extends BaseWalletAdapter {
    name: WalletName<"FoxWallet">;
    url: string;
    icon: string;
    ...
    constructor({ timeout }?: FoxWalletAdapterConfig);
